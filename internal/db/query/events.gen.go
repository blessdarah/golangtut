...
func newEvent(db *gorm.DB, opts ...gen.DOOption) event {
	...
	_event.eventDo.UseModel(&persistence.Event{})

	tableName := _event.eventDo.TableName()
	_event.ALL = field.NewAsterisk(tableName)
	_event.ID = field.NewString(tableName, "id")
	_event.UserID = field.NewString(tableName, "user_id")
	_event.Name = field.NewString(tableName, "name")
	_event.Description = field.NewString(tableName, "description")
	_event.Venue = field.NewString(tableName, "venue")
	_event.StartDate = field.NewTime(tableName, "start_date")
	_event.EndDate = field.NewTime(tableName, "end_date")
	...
	_event.User = eventBelongsToUser{
		...
		RelationField: field.NewRelation("User", "persistence.User"),
	}
...
func (e *event) updateTableName(table string) *event {
	...
	e.Venue = field.NewString(table, "venue")
...
func (a eventBelongsToUser) Model(m *persistence.Event) *eventBelongsToUserTx {
	return &eventBelongsToUserTx{a.db.Model(m).Association(a.Name())}
}

type eventBelongsToUserTx struct{ tx *gorm.Association }

func (a eventBelongsToUserTx) Find() (result *persistence.User, err error) {
	return result, a.tx.Find(&result)
}

func (a eventBelongsToUserTx) Append(values ...*persistence.User) (err error) {
...
func (a eventBelongsToUserTx) Replace(values ...*persistence.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a eventBelongsToUserTx) Delete(values ...*persistence.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IEventDo interface {
	...
	Unscoped() IEventDo
	Create(values ...*persistence.Event) error
	CreateInBatches(values []*persistence.Event, batchSize int) error
	Save(values ...*persistence.Event) error
	First() (*persistence.Event, error)
	Take() (*persistence.Event, error)
	Last() (*persistence.Event, error)
	Find() ([]*persistence.Event, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*persistence.Event, err error)
	FindInBatches(result *[]*persistence.Event, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*persistence.Event) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*persistence.Event, error)
	FirstOrCreate() (*persistence.Event, error)
	FindByPage(offset int, limit int) (result []*persistence.Event, count int64, err error)
...
func (e eventDo) Create(values ...*persistence.Event) error {
	if len(values) == 0 {
		return nil
	}
...
func (e eventDo) CreateInBatches(values []*persistence.Event, batchSize int) error {
	return e.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (e eventDo) Save(values ...*persistence.Event) error {
	if len(values) == 0 {
		return nil
	}
...
func (e eventDo) First() (*persistence.Event, error) {
	if result, err := e.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*persistence.Event), nil
	}
}

func (e eventDo) Take() (*persistence.Event, error) {
...
func (e eventDo) Last() (*persistence.Event, error) {
...
func (e eventDo) Find() ([]*persistence.Event, error) {
	result, err := e.DO.Find()
	return result.([]*persistence.Event), err
}

func (e eventDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*persistence.Event, err error) {
	buf := make([]*persistence.Event, 0, batchSize)
...
func (e eventDo) FindInBatches(result *[]*persistence.Event, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (e eventDo) FirstOrInit() (*persistence.Event, error) {
...
func (e eventDo) FirstOrCreate() (*persistence.Event, error) {
...
func (e eventDo) FindByPage(offset int, limit int) (result []*persistence.Event, count int64, err error) {
...
func (e eventDo) Delete(models ...*persistence.Event) (result gen.ResultInfo, err error) {
